...
def create_app(
    *,
    ...
    relay_url = os.environ.get("MCP_RELAY_URL", "https://better-telegram-mcp.n24q02m.com")
    oauth = OAuthProvider(
    ...
    auth_provider = TelegramAuthProvider(data_dir, int(os.getenv("TELEGRAM_API_ID", 0) or 0), os.getenv("TELEGRAM_API_HASH", ""))
    ...
    async def authorize(request: Request) -> JSONResponse | RedirectResponse:
        ...
        try:
            ...
            return JSONResponse({"error": "server_error", "description": str(e)}, status_code=500)
    ...
    async def token(request: Request) -> JSONResponse:
        ...
        try:
            ...
            if credentials.get("TELEGRAM_BOT_TOKEN"):
                await auth_provider.register_bot(user_id, credentials["TELEGRAM_BOT_TOKEN"])
            ...
            return JSONResponse({"error": "server_error", "description": msg}, status_code=500)
        except Exception as e:
    ...
    class BearerAuthMCPApp:
        ...
        async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
            ...
            if backend is None:
                ...
                if creds.get("TELEGRAM_BOT_TOKEN"):
                    try:
                        await auth_provider.register_bot(user_id, creds["TELEGRAM_BOT_TOKEN"])
                    except Exception:
