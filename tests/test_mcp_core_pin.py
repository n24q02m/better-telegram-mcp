...
def test_mcp_core_pin_includes_storage_seam():
    ...
    # Storage backends + token/session sub-key first usable at 1.18.0b5; the
    # StringSession seam (Subsystem A) lands at the next beta and re-pins this.
    assert "1.18.0b7" in core, f"expected >=1.18.0b7 floor, got: {core}"
