...
class MockBackend(TelegramBackend):
    ...
    async def send_message(self, chat_id: str | int, text: str, *, reply_to: int | None = None, parse_mode: str | None = None) -> dict[str, Any]: ...
    async def edit_message(self, chat_id: str | int, message_id: int, text: str, *, parse_mode: str | None = None) -> dict[str, Any]: ...
    async def delete_message(self, chat_id: str | int, message_id: int) -> bool: ...
    async def forward_message(self, from_chat: str | int, to_chat: str | int, message_id: int) -> dict[str, Any]: ...
    async def pin_message(self, chat_id: str | int, message_id: int) -> bool: ...
    async def react_to_message(self, chat_id: str | int, message_id: int, emoji: str) -> bool: ...
    async def search_messages(self, query: str, *, chat_id: str | int | None = None, limit: int = 20) -> list[dict[str, Any]]: ...
    async def get_history(self, chat_id: str | int, *, limit: int = 20, offset_id: int | None = None) -> list[dict[str, Any]]: ...
    async def list_chats(self, *, limit: int = 50) -> list[dict[str, Any]]: ...
    async def get_chat_info(self, chat_id: str | int) -> dict[str, Any]: ...
    async def create_chat(self, title: str, *, is_channel: bool = False) -> dict[str, Any]: ...
    async def join_chat(self, link_or_hash: str) -> bool: ...
    async def leave_chat(self, chat_id: str | int) -> bool: ...
    async def get_members(self, chat_id: str | int, *, limit: int = 50) -> list[dict[str, Any]]: ...
    async def promote_admin(self, chat_id: str | int, user_id: int, *, demote: bool = False) -> bool: ...
    async def update_chat_settings(self, chat_id: str | int, **kwargs: Any) -> bool: ...
    async def manage_topics(self, chat_id: str | int, action: str, **kwargs: Any) -> dict[str, Any]: ...
    async def send_media(self, chat_id: str | int, media_type: str, file_path_or_url: str, *, caption: str | None = None) -> dict[str, Any]: ...
    async def download_media(self, chat_id: str | int, message_id: int, *, output_dir: str | None = None) -> str: ...
    async def list_contacts(self) -> list[dict[str, Any]]: ...
    async def search_contacts(self, query: str) -> list[dict[str, Any]]: ...
    async def add_contact(self, phone: str, first_name: str, *, last_name: str | None = None) -> bool: ...
